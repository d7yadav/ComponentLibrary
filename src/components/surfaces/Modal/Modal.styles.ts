...
import type { ModalVariant, ModalPosition, ModalSize, ModalAnimation } from './Modal.types';
// Animation keyframes
...
export const StyledModal: React.ComponentType<any> = styled(MuiModal, {
...
}>(({ variant, backdrop, animationDuration }) => ({
  'display': 'flex',
  'alignItems': 'center',
...
export const StyledModalContainer: React.ComponentType<any> = styled(Box, {
  shouldForwardProp: (prop) => 
...
export const StyledModalContent: React.ComponentType<any> = styled(Paper, {
  shouldForwardProp: (prop) => 
...
export const StyledModalHeader: React.ComponentType<any> = styled(Box)(({ theme }) => ({
  'display': 'flex',
  'alignItems': 'center',
...
export const StyledModalBody: React.ComponentType<any> = styled(Box, {
...
export const StyledModalFooter: React.ComponentType<any> = styled(Box)(({ theme }) => ({
  'display': 'flex',
  'alignItems': 'center',
...
export const StyledCloseButton: React.ComponentType<any> = styled(IconButton)(({ theme }) => ({
