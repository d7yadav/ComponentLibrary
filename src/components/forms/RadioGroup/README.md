...
The RadioGroup component is a simple forms component that provides [brief description of functionality]. It's built with accessibility, performance, and developer experience in mind.
...
See [Examples](RadioGroup.examples.md) for comprehensive usage examples including:
...
See [AI Guide](RadioGroup.ai-guide.md) for implementation details.
