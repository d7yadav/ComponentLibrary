...
The Alert component is a very-complex feedback component that provides [brief description of functionality]. It's built with accessibility, performance, and developer experience in mind.
...
See [Examples](Alert.examples.md) for comprehensive usage examples including:
...
See [AI Guide](Alert.ai-guide.md) for implementation details.
