# 🤖 AI Coding Guide: CircularProgress
...
4. **❌ Missing accessibility attributes**
   ```typescript
   // Wrong
   <CircularProgress onClick={handler} />
   ```
...
- [ ] Props interface is properly typed with `CircularProgressProps`
...
4. **Interaction Testing**:
   ...
   it('handles user interactions', async () => {
     ...
     render(<CircularProgress onClick={handleClick} />);
