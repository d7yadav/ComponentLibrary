...
/**
 * StyledLinearProgress component
 * 
 * @returns JSX element
 */
...
export const StyledCircularProgress = styled(MuiCircularProgress, {
  ...
  return {
    // Size
    width: customSize || sizeConfig.circularSize,
    height: customSize || sizeConfig.circularSize,
 ...
 * @returns JSX element
 */
export const ProgressContainer = styled(Box)<any>((props: any) => {
 ...
 * @returns JSX element
 */
export const ProgressLabel = styled(Box)<any>((props: any) => {
 ...
 * @returns JSX element
 */
export const ProgressValue = styled(Box)<any>((props: any) => {
  const { theme, customSize = 'medium' } = props;
  const sizeConfig = PROGRESS_SIZE_CONFIGS[customSize as keyof typeof PROGRESS_SIZE_CONFIGS];
 ...
 * @returns JSX element
 */
export const LoadingProgress = styled(StyledLinearProgress)<any>(() => ({
  '& .MuiLinearProgress-bar': {
...
/**
 * PulsingProgress component
 * 
 * @returns JSX element
 */
export const PulsingProgress = styled(StyledCircularProgress)<any>(() => ({
  animation: `${pulse} 2s ease-in-out infinite`,
}));

/**
 * StripedProgress component
 * 
 * @returns JSX element
 */
export const StripedProgress = styled(StyledLinearProgress)<any>(() => ({
  '& .MuiLinearProgress-bar': {
    backgroundImage: `linear-gradient(
      45deg,
      rgba(255, 255, 255, 0.15) 25%,
...
/**
 * ThinProgress component
 * 
 * @returns JSX element
 */
export const ThinProgress = styled(StyledLinearProgress)<any>(() => ({
  height: 2,
...
/**
 * ThickProgress component
 * 
 * @returns JSX element
 */
export const ThickProgress = styled(StyledLinearProgress)<any>((props: any) => {
  const { theme } = props;
  return {
    height: 12,
    borderRadius: 6,
 ...
 * @returns JSX element
 */
export const GradientProgress = styled(StyledLinearProgress)<any>((props: any) => {
  const { theme } = props;
  return {
    '& .MuiLinearProgress-bar': {
...
/**
 * MiniCircularProgress component
 * 
 * @returns JSX element
 */
export const MiniCircularProgress = styled(StyledCircularProgress)<any>(() => ({
  width: 16,
  height: 16,
...
/**
 * LargeCircularProgress component
 * 
 * @returns JSX element
 */
export const LargeCircularProgress = styled(StyledCircularProgress)<any>(() => ({
  width: 80,
  height: 80,
