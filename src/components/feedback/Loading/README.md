...
The Skeleton component is a medium feedback component that provides [brief description of functionality]. It's built with accessibility, performance, and developer experience in mind.
...
See [Examples](Skeleton.examples.md) for comprehensive usage examples including:
...
See [AI Guide](Skeleton.ai-guide.md) for implementation details.
