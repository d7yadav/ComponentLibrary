...
The Button component is a complex core component that provides [brief description of functionality]. It's built with accessibility, performance, and developer experience in mind.
...
See [Examples](Button.examples.md) for comprehensive usage examples including:
...
See [AI Guide](Button.ai-guide.md) for implementation details.
