...
// Specialized CSS Grid components
/**
 * CssGrid component
 * 
 * @returns JSX element
 ...
 * @returns JSX element
 */
export const AutoGrid = styled(CssGrid)<{
...
// Holy Grail layout
/**
 * HolyGrailGrid component
 * 
 * @returns JSX element
 */
export const HolyGrailGrid = styled(CssGrid)((props: any) => {
  const { theme } = props;
  return {
 ...
 * @returns JSX element
 */
export const ResponsiveCardGrid = styled(CssGrid)((props: any) => {
  const { theme } = props;
  return {
