...
- **Types**: text, email, password, number, search, tel, url, date, time
- **Variants**: standard, outlined, filled
- **Validation**: Built-in validation with error states
- **Accessibility**: Full screen reader support, proper labeling
- **Form Integration**: React Hook Form compatibility
- **Dark Theme**: Optimized input styling
- **States**: default, focused, error, disabled, readonly, loading
- **Input Adornments**: Start and end adornments
- **Character Counter**: Optional character limit display
- **Auto-complete**: Integration with browser autocomplete
- **Masking**: Input masking for phone, credit card, etc.
